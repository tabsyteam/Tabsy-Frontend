...
import { OrderTrackingShared } from '@/components/table/OrderTrackingShared'
import { useTableSessionData } from '@/hooks/useTableSessionData'

export function OrderTrackingWrapper() {
  ...
  if (error || !tableSession || !currentUser) {
    return (
      <div className="p-4 text-center">
        <h2 className="text-lg font-semibold mb-2">Unable to Load Order Tracking</h2>
